        ...
        <UContainer class="py-8 lg:py-12">
          ...
          >
            ...
            <div class="flex-1 max-w-md">
              <h2 class="heading-03-600 text-gray-900 mb-3">
                Subscribe our Newsletter
              </h2>
              <p class="body-medium text-gray-600">
            ...
            >
              ...
              >
                <UButton
                  ...
                  class="bg-gray-800 hover:bg-gray-700 text-white rounded-full"
                />
              </div>
            </div>
          </div>
    ...
    <template #bottom>
      <div class="bg-primary-800">
        <UContainer class="py-4 lg:py-6">
          ...
          >
            ...
            <div class="sm:col-span-2 lg:col-span-1">
              <Logo
                ...
                class="mb-4"
              />
              <p class="body-medium text-gray-300 mb-4">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do
                eiusmod tempor incididunt ut labore et dolore magna aliqua.
              </p>
              <div class="flex flex-col gap-2">
                <a
                  ...
                  class="body-medium text-primary-400 hover:text-primary-300 transition-colors"
                >
                  +84 909 090 909
                </a>
                <a
          ...
          <div
            class="border-t border-primary-700 pt-3 mt-2 flex flex-col sm:flex-row items-center justify-between gap-4"
          >
            <!-- Left: Copyright -->
            <p class="body-medium text-gray-300 text-center sm:text-left">
              Agriculture eCommerce © {{ currentYear }}. All Rights Reserved
            </p>
